...
\newgeometry {bindingoffset=1cm, top=2.5cm, bottom=2.5cm, right=2.5cm, left=2.5cm}
...
\newcounter{supervisorscount}
\titlespacing*{\section} {0pt}{4ex}{2ex}
%\titlespacing{\section}{0pt}{\parskip}{-\parskip}
%\titlespacing{\subsection}{0pt}{\parskip}{-\parskip}

\newcommand{\lstsetlarge}{\lstset{
  language=Python,
  numbers=left,
  numberstyle=\tiny,
  numbersep=5pt,
...
\newcommand{\lstsetnormal}{\lstset{
  ...
  columns=fullflexible,
  showstringspaces=false,
  basewidth=0.4em, % Reduce the width of each character
  lineskip=0.35em % Reduce line spacing
}}
