...
Starting from $G^{aux}$, each edge belonging to $E^{aux}$ will have a new weight assigned to it. 
This weight will be divided equally between the two nodes as a fair contribution from both.
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.45\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \node[circle, draw, minimum size=1cm, fill=white] (4) at (8, -6.5) {Cluster 4};
      \node[circle, draw, minimum size=1cm, fill=white] (5) at (8,-10) {Cluster 5};
      \node[circle, draw, minimum size=1cm, fill=white] (6) at (8,-13.5) {Cluster 6};
...
\end{figure}
\clearpage
Now we will discuss two algorithmns for computing the MaxWPM.
