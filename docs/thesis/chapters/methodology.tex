...
\textbf{Interquantile Range} measures statistical dispersion in the range between the 25th (Q1) and the 75th percentile (Q3) of the data distribution ($ iqr = Q3 - Q1 $):
        ...
        \begin{figure}[H]
            ...
            \caption{Interquantile range of a normal distribution TODO va fatta non colorata ma con una freccia}
            \label{fig:iqr}
        \end{figure}
...
La scelta del LOOCV è stata motivata dalla presenza di un dataset molto piccolo che permette di computare il massimo numero di cicli di addestramento di modo da avere un modello praticamente unbiased.
