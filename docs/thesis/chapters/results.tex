...
\begin{itemize}
  ...
  \item and the division into the upper and lower body part, which is in the same tables.
\end{itemize} 
...
Furthermore, for a more comprehensive assessment of the results, we included the TSS (True Skill Statistic), normalized between 0 and 1 and presented as a percentage. 
