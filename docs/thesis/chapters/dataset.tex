...
The dataset comprises 60 segments recorded using different versions of the \textit{Qualisys Motion Capture system}, divided between 58 recordings coming from the "WhoLoDance" and 2 from the "Montpellier - Unige" session.
