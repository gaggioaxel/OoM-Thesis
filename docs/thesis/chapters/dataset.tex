...
Unfortunately, the dataset is unbalanced, meaning that there are some classifications that are very frequent, some that are infrequent, and some classifications that are completely absent.
