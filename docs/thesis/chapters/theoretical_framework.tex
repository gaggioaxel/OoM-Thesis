...
\item{\textbf{True Positives (TP)}: The model correctly predicted a positive class. For example, if we are trying to identify spam emails, and the model correctly classified an email as spam, it is a True Positive.} \\
...
\begin{itemize}
  ...
  \textbf{Recall} measures the percentage of actual positive cases that were correctly predicted by the model.
