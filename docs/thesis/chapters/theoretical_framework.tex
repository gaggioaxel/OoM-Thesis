...
TODO spiegare sta robba di sto esempio
\begin{figure}[H]
  \centering
...
\begin{figure}[H]
  ...
  \begin{subfigure}{0.52\linewidth}
    \includegraphics[width=\linewidth]{graphics/DatasetDecTree.png}
    \caption{}
    \label{fig:exampleDatasetDT}
  \end{subfigure}
  \hspace{0.03\linewidth}
  \begin{subfigure}{0.43\linewidth}
    \includegraphics[width=\linewidth]{graphics/DecTree.png}
    \caption{}
    \label{fig:knn5}
  \end{subfigure}
  \caption{A simple dataset and the Decision Tree trained on it}
\end{figure}
