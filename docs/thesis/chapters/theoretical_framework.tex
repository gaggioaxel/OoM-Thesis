...
\begin{figure}[H]
    ...
    \begin{minipage}{0.5\textwidth}
        ...
        \]
    \end{minipage}
    \caption{Graph \textit{G} with its adjacency \textit{A} and incidence \textit{I} matrices}
...
We will describe the application of the HM to address minimum-weight matching problems.
\\

\subsubsection{Hungarian Matching Algorithm summarized}
...
Let's take for example the same cost matrix of the Brute Force example and try to apply the HM for minimum-weigth matching problems:
