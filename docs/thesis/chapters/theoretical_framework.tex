...
A synthetic sample can be generated randomly within the feature space of the minority class or considering its underlying data distribution (ADASYN).
...
The \textbf{SMOTE}  generates synthetic samples by interpolating between neighboring minority class instances.\\

The \textbf{B-SMOTE}, is an enhancement of the SMOTE used in the field of imbalanced machine learning. 
It is a valuable technique for addressing class imbalance problems, where one class (the minority class) has significantly fewer instances than another class (the majority class).
