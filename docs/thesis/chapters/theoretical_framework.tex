...
The KNN algorithm is a supervised machine learning algorithm used for classification and regression tasks.
...
The B-SMOTE, is an enhancement of the Synthetic Minority Over-sampling Technique (SMOTE) used in the field of imbalanced machine learning. 
