...
\begin{figure}[H]
  \centering  
    \includegraphics[width=\linewidth]{mean_median_filter.png}
...
%    of the game.}
%    \item {The game is said to be \textit{fair} game if the value of the game is zero otherwise it is known as \textit{unfair}.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{BinaryClassification.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{KNeighbours.png}
