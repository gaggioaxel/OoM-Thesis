...
%Let's take for example the following cost matrix and try to apply the BF for MinWPM problems:
%
%\begin{table}[H]
%    \centering
...
Let's take an example of a cost matrix and try to apply the HM for MinWPM problems:
