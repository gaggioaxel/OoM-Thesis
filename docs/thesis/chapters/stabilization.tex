...
In this first example, in Figure 1, we can observe the results of stabilization between two different instants in time. 
...
\begin{figure}[H]
  ...
  \caption{Clustering at $t=7.54$ (a), $t=7.84$ unstabilized (b), and $t=7.84$ stabilized (c).}
  \label{fig:stabilization_results}
\end{figure}
TODO redo this picture because t = something is a bit too big\\
TODO might add a qr code linked to a GIF